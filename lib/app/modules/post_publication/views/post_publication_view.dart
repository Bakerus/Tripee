                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return CardPostActivity(
                            ...
                            ontapForDeleted: () => controller.deleteTrajetById(
                            ...
                            ontapForDetail: () =>
                                NavigationHelper.navigateWithFadeWithtBack(
                                    ...
                                    LocationOnMapView(
                                      ...
                                      vehicleBrand: trajet.vehicle.vehicleBrand,
                                      vehiceNumber:
                                          trajet.vehicle.registrationNumber,
                                      email: trajet.user.email,
                                      imagePath: trajet.vehicle.imagePath,
                                      availablePlaces: "",
                                      latitudeDeparture: double.parse(trajet.departurePlace.latitude),
                                      longitudeDeparture: double.parse(trajet.departurePlace.longitude),
                                      latitudeArrival: double.parse(trajet.arrivalPlace.latitude),
                                      longitudeArrival: double.parse(trajet.arrivalPlace.longitude),
                                      maxPlaces:
                                          trajet.availablePlaces.toString(),
                                      state:
                                          controller.parseStatut(trajet.status),
                                      action: "Publication",
                                    )),
                          );
                        },
